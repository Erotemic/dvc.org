...
An [Open Science Framework](https://osf.io/) account is needed to use OSF
storage. Please also run `pip install osfclient` to install the Python package
that allows DVC to communicate with the OSF API.
